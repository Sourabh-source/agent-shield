...
import { ShieldCheck, Terminal, Layers, PlusCircle, ExternalLink } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-1 border-l border-slate-800/80 pl-5 text-xs font-medium">
                <Link
                  href="/"
                  className="px-3 py-1.5 rounded-md text-slate-300 hover:text-white hover:bg-slate-800/50 transition-colors flex items-center gap-1.5"
                >
